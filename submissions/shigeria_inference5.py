...
class LitModel(nn.Module):
    ...
    def forward(self, input_ids, attention_mask):
        ...
        return self.linear(torch.cat([cls_pooling, norm_mean_embeddings], -1))
...
if __name__ == "__main__":
    ...
    for index in range(5):
        model_path = (
            f"../input/commonlit-attention-concat-mean-pooling/model_{index + 1}.pth"
        )
        print(f"\nUsing {model_path}")
    ...
    np.save("shigeria_pred7", predictions.reshape(-1, 1))
